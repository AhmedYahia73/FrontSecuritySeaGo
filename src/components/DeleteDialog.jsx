...
export default function DeleteDialog({
  ...
  return (
    <Dialog open={open ?? isOpen ?? false} onOpenChange={handleOpenChange}>
      <DialogContent className="bg-white !p-10 rounded-lg shadow-md max-w-md">
        ...
        <p className="text-gray-600">
          Are you sure you want to delete the row "{name || selectedRow?.name || selectedRow?.comment || "this item"}"? This action cannot be undone.
        </p>
